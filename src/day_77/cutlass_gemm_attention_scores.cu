...
int main(int argc, char* argv[]) {
    ...
    cutlass::Status status = attention_scores<float>(L, L, D, alpha, A, lda, batch_stride_A, B, ldb, batch_stride_B, C, ldc, batch_stride_C, beta, batch_count);
